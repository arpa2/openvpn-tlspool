...
#if defined(ENABLE_CRYPTO) && defined(ENABLE_CRYPTO_POLARSSL) && !defined(ENABLE_BACKEND_TLSPOOL)
...
#endif /* defined(ENABLE_CRYPTO) && defined(ENABLE_CRYPTO_POLARSSL) && !defined(ENABLE_BACKEND_TLSPOOL) */
